...
<head>
    ...
    <title>{{ __('Register') }} — AzuraShop</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .link-login { color: #e94560; text-decoration: none; font-weight: 600; transition: color 0.2s; }
        .link-login:hover { color: #ff6b6b; }
        .login-text { text-align: center; color: rgba(255,255,255,.5); font-size: 0.85rem; margin-top: 1.5rem; }
...
<div class="auth-card">
    ...
    <p class="subtitle">{{ __('Sign up for free and start shopping') }}</p>
    ...
    <form action="{{ route('register.post') }}" method="POST">
        ...
        <div>
            ...
            <div class="input-wrapper">
                ...
                <input type="text" name="name" class="form-control"
                       value="{{ old('name') }}" placeholder="{{ __('Your Name') }}" required autofocus>
            </div>
        </div>
        ...
        <div>
            ...
            <div class="input-wrapper">
                ...
                <input type="password" name="password_confirmation" id="passwordConfirmationInput" class="form-control password-input"
                       placeholder="{{ __('Confirm Password') }}" required>
                <button type="button" class="password-toggle-btn" onclick="togglePasswordVisibility('passwordConfirmationInput', this)">
                    <i class="bi bi-eye"></i>
                </button>
            </div>
        </div>
    ...
    <div class="login-text">
        {{ __('Already have an account?') }} <a href="{{ route('login') }}" class="link-login">{{ __('Login') }}</a>
    </div>
